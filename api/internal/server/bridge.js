...
function applyTheme(t){if(t!=='dark'&&t!=='light')return;curTheme=t;const d=doc();if(!d||!d.documentElement)return;const r=d.documentElement;r.setAttribute('data-aidocs-theme',t);r.setAttribute('data-aidocs-color-scheme',t);try{d.defaultView.dispatchEvent(new CustomEvent('aidocs:theme',{detail:{theme:t}}))}catch(e){}}
